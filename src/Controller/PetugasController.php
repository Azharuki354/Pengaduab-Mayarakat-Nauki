     ...
     public function delete($id = null)
     {
         ...
         if($id!=$id_petugas){
             if ($this->Petugas->delete($petuga)) {
                 $this->Flash->success(('The petuga has been deleted.'));
             } else {
                 $this->Flash->error(('The petuga could not be deleted.Please, try again.'));
             }
         } else {
             $this->Flash->error(('Mohon maaf anda tidak bisa menghapus akun anda sendiri, silahkan menghubungi admin untuk konfirmasi hapus data pengguna'));
         }
         return $this->redirect(['action' => 'index']);
     }
