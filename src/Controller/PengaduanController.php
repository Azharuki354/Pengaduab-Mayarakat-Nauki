    ...
    public function delete($id = null)
    {
        ...
        if(empty($cekTanggapan)){
            if ($this->Pengaduan->delete($pengaduan)) {
                $this->Flash->success(('The pengaduan has been deleted.'));
            } else {
                $this->Flash->error(('The pengaduan could not be deleted. Please, try again.'));
            }
        } else {
            $this->Flash->warning(('Data tanggapan pada pengaduan '.$pengaduan->isi_laporan.
